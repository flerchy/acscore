...
class SpacesNearSquareBrackets:
    """ Checks whether square brackets are divided from content with spaces. """
    ...
    inspections = {
        NEED_SPACES: 'Mostly spaces are put near square brackets, '
                     'maybe you need to add spaces near square brackets here.',
        NEED_NO_SPACES: 'No spaces near square brackets are used in the source code, '
    ...
    def inspect(self, discrete, values):
        ...
        # Issue messages for all square brackets where spaces after or before prevail (or overwise)
        if spaces:
